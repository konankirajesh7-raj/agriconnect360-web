...
- Name: e2e-full.spec.js >> Round 7: Route Smoke Tests >> 7.x Route /about loads
- Location: tests\e2e-full.spec.js:254:5

# Error details

```
Error: page.goto: net::ERR_TIMED_OUT at https://agriconnect360-web.vercel.app/about
Call log:
  - navigating to "https://agriconnect360-web.vercel.app/about", waiting until "domcontentloaded"
