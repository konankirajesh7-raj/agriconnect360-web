...
- Name: e2e-full.spec.js >> Round 7: Route Smoke Tests >> 7.x Route /register loads
- Location: tests\e2e-full.spec.js:254:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at https://agriconnect360-web.vercel.app/register
Call log:
  - navigating to "https://agriconnect360-web.vercel.app/register", waiting until "domcontentloaded"
