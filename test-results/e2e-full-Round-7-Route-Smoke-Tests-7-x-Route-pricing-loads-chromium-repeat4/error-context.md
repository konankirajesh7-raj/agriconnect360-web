...
- Name: e2e-full.spec.js >> Round 7: Route Smoke Tests >> 7.x Route /pricing loads
- Location: tests\e2e-full.spec.js:254:5

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://agriconnect360-web.vercel.app/pricing
Call log:
  - navigating to "https://agriconnect360-web.vercel.app/pricing", waiting until "domcontentloaded"
