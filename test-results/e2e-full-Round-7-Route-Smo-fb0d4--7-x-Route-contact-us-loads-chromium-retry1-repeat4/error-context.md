...
- Name: e2e-full.spec.js >> Round 7: Route Smoke Tests >> 7.x Route /contact-us loads
- Location: tests\e2e-full.spec.js:254:5

# Error details

```
Error: page.goto: net::ERR_TIMED_OUT at https://agriconnect360-web.vercel.app/contact-us
Call log:
  - navigating to "https://agriconnect360-web.vercel.app/contact-us", waiting until "domcontentloaded"
